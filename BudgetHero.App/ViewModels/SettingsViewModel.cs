...
{
    public partial class SettingsViewModel : ViewModelBase, IBusyHandler
    {
        ...
        public SettingsViewModel(IModalDisplayHandler displayHandler)
        {
            _displayHandler = displayHandler;
            Title = Resources.Languages.AppResource.SettingsView_Title;
        }
